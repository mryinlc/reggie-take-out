...
public class JwtUtil {
    ...
    // jwt签发者
    private final static String jwt_iss = "mryinlc";

    // jwt所有人
    private final static String subject = "mryinlc";
     ...
     */
    public static String generateJwtToken(Long usrId, String name, String identity) {
    ...
    public static Claims getClaimsFromJwt(String jwt) {
        ...
        try {
            ...
            // throw new NotLoginException("Jwt信息有误");
            throw new CustomException("Jwt信息有误");
        }
        return claims;
    }
